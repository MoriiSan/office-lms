  ...
  return (
    <>
      <div className=" flex flex-col h-screen bg-[#fbe9da] text-[#071e22] ">
        ...
        <div className="flex flex-grow justify-start items-stretch gap-6 ">
          {/* px-16 py-4 */}
          <div className="sidebar-component flex flex-col flex-wrap ps-16 p-3 w-[364px] min-w-[250px] bg-[#e7ceba] text-[#071e22]  gap-6 ">
            <div className="profile-component items-center flex gap-4 px-2 text-[#071e22]">
              <FaUserCircle
                size={40}
            ...
            <div className="flex flex-col gap-2 text-md font-normal text-[#071e22]">
              <div className="relative flex py-1.5 px-4 mb-2 justify-start items-center bg-[#071e22] text-[#fbe9da] font-semibold rounded-md">
              ...
              <div className="relative flex py-1.5 px-4 justify-start items-center bg-[#] text-[#071e22] rounded-md">
                <span className="relative h-6 w-6">
                  <BooksIcon hex={"#071e22"} />
                </span>
          ...
          <div className="other-sidebar flex flex-col pe-16  w-[364px] min-w-[250px] border-[#071e22] text-sm text-[#071e22] gap-2">
